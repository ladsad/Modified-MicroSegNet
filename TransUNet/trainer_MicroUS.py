...
def trainer_MicroUS(args, model, snapshot_path):
    ...
    worker_init_fn_args = partial(worker_init_fn, args)
    trainloader = DataLoader(db_train, batch_size=batch_size, shuffle=True, num_workers=8, worker_init_fn=worker_init_fn_args)

...
class PreActBottleneck(nn.Module):
    ...
    def __init__(self, cin, cout=None, cmid=None, stride=1):
        ...
        self.conv1 = conv1x1(cin, cmid, bias=False) # reducing dimensions
        self.gn2 = nn.GroupNorm(32, cmid, eps=1e-6)
        self.conv2 = conv3x3(cmid, cmid, stride, bias=False)  # bottleneck performing main computation
        self.gn3 = nn.GroupNorm(32, cout, eps=1e-6)
        self.conv3 = conv1x1(cmid, cout, bias=False)    # increasing dimensions
        self.relu = nn.ReLU(inplace=True)

        # downsample to the channel number to cout, make sure the residual can be added.
